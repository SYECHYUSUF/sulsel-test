...
class PengajuanDisposisi extends Model
{
    protected $table = 'tbl_pengajuan_disposisi';
    ...
    /**
     * Relasi ke PengajuanKeberatan
     */
    public function pengajuan(): BelongsTo
    {
        return $this->belongsTo(PengajuanKeberatan::class, 'id_pengajuan', 'id_pengajuan');
    }
    ...
    {
        return $this->hasMany(PengajuanRespon::class, 'id_disposisi', 'id_disposisi');
    }
