        ...
        <form id="form-alasan-create" method="POST" action="{{ route('admin.master-data.alasan-pengajuan.store') }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="alasan-alasan-create" name="alasan" rows="3" required
                    class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-ppid-primary dark:focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-slate-100"
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit"
                    class="px-4 py-2 text-sm font-medium text-white bg-ppid-primary rounded-lg hover:bg-ppid-dark transition-colors">
                    Simpan
                </button>
            </div>
        </form>
