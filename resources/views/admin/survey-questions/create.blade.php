                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-300 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group @error('tipe') border-red-500 @enderror">
                                <input type="radio" name="tipe" value="radio" {{ old('tipe') == 'radio' ? 'checked' : '' }} class="w-5 h-5 text-[#1A305E] focus:ring-2 focus:ring-[#1A305E]" required />
                                <div>
                            ...
                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-300 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group @error('tipe') border-red-500 @enderror">
                                <input type="radio" name="tipe" value="textarea" {{ old('tipe') == 'textarea' ? 'checked' : '' }} class="w-5 h-5 text-[#1A305E] focus:ring-2 focus:ring-[#1A305E]" />
                                <div>
