    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">Buat pertanyaan survey baru</p>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-300 dark:border-slate-600 cursor-pointer hover:border-ppid-primary hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group @error('tipe') border-red-500 @enderror">
                                <input type="radio" name="tipe" value="radio" {{ old('tipe') == 'radio' ? 'checked' : '' }} class="w-5 h-5 text-ppid-primary focus:ring-2 focus:ring-ppid-primary" required />
                                <div>
                            ...
                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-300 dark:border-slate-600 cursor-pointer hover:border-ppid-primary hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group @error('tipe') border-red-500 @enderror">
                                <input type="radio" name="tipe" value="textarea" {{ old('tipe') == 'textarea' ? 'checked' : '' }} class="w-5 h-5 text-ppid-primary focus:ring-2 focus:ring-ppid-primary" />
                                <div>
