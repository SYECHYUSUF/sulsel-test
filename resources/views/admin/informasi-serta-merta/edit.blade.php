<x-admin-layout title="Edit Informasi Serta Merta - Admin PPID">
    <x-slot name="header">
        <div class="flex items-center gap-2">
            ...
            <span>Edit Informasi Serta Merta</span>
        </div>
    </x-slot>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.informasi-serta-merta.update', $item->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
