<x-admin-layout title="Tambah Informasi Daftar Publik - Admin PPID">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden max-w-4xl mx-auto"
        ...
        <div class="p-6 border-b border-slate-100 dark:border-slate-700">
            <h3 class="text-lg font-bold text-ppid-primary dark:text-blue-400">Form Tambah Data</h3>
        </div>

        <form id="createForm" action="{{ route('admin.matriks-dip.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
