            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-white/90 text-sm">Pantau dan kelola permintaan informasi publik dari masyarakat.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div class="relative">
                        <select x-model="statusFilter" @change="fetchData()"
                            ...
                            <option value="Menunggu Verifikasi" class="bg-slate-800 text-white">Menunggu Verifikasi
                            </option>
                        ...
                        <template x-if="!loading">
                            <template x-for="item in items" :key="item.id_permohonan">
                                <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-slate-100" x-text="item.nama">
                                        </div>
                                        <div class="text-xs text-slate-400 dark:text-slate-500"
                                            x-text="item.kategori_pemohon"></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-slate-600 dark:text-slate-300" x-text="item.email"></div>
                                        <div class="text-xs text-slate-400 dark:text-slate-500" x-text="item.no_hp">
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right flex justify-end gap-2">
                                        ...
                                        <template x-if="[2, 3, 4].includes(item.status)">
                                            <button
                                                @click="confirmDeleteItem('/admin/permohonan-informasi/' + item.id_permohonan)"
