<x-admin-layout>
    <x-slot:title>Profil Pemerintah Sulsel</x-slot:title>
...
<div class="p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-800 dark:text-white mb-2">Profil Pemerintah Sulsel</h1>
                <p class="text-slate-600 dark:text-slate-400">Kelola konten halaman Profil Pemerintah Sulawesi Selatan</p>
            </div>
        </div>
    ...
    <div x-data="{ showSuccess: {{ session('success') ? 'true' : 'false' }} }">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8">
            ...
            <form action="{{ route('admin.profil-pemprov.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           name="nm_profil" 
                           value="{{ old('nm_profil', $profil->nm_profil ?? 'Profil Pemerintah Sulawesi Selatan') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        @if(isset($profil->foto_gubernur) && $profil->foto_gubernur)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $profil->foto_gubernur) }}" 
                    ...
                    <div>
                        ...
                        @if(isset($profil->foto_wakil) && $profil->foto_wakil)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $profil->foto_wakil) }}" 
