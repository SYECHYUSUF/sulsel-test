<x-admin-layout title="Banner Slide - Admin PPID">
    <div class="space-y-6" x-data="{
        ...
        <x-confirmation-dialog trigger="deleteModalOpen" title="Hapus Banner?"
            description="Apakah Anda yakin ingin menghapus banner ini?" confirmText="Ya, Hapus" theme="danger"
