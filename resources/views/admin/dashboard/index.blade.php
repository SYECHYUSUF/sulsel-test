<x-admin-layout title="Dashboard Admin - PPID Sulsel">
    ...
    <div class="space-y-6 pb-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-blue-300 transition-all">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="text-xs font-medium py-1 px-2 bg-green-100 text-green-700 rounded-full">+12%</span>
                </div>
                <div>
                    <p class="text-sm font-medium text-slate-500">Permohonan</p>
                    <h2 class="text-2xl font-bold text-slate-800">40</h2>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-red-300 transition-all">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-slate-800">21</h2>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-amber-300 transition-all">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-slate-800">14</h2>
                </div>
            </div>

            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-emerald-300 transition-all">
                <div class="flex justify-between items-start mb-4">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-slate-800">54</h2>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-indigo-300 transition-all">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-slate-800">3.6k</h2>
                </div>
            </div>

            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:border-purple-300 transition-all">
                <div class="flex justify-between items-start mb-4">
                ...
                <div>
                    ...
                    <h2 class="text-2xl font-bold text-slate-800">12k</h2>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-6">
                    ...
                    @foreach(['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'] as $month)
                        <div class="flex flex-col items-center justify-end h-full w-full group relative z-10">
                            <div class="flex items-end justify-center w-full gap-1.5 h-full pb-8">
                                <div class="w-3 bg-[#1A305E] rounded-t-sm transition-all duration-300 group-hover:brightness-125" style="height: {{ rand(40, 90) }}%"></div>
                                <div class="w-3 bg-[#D4AF37] rounded-t-sm transition-all duration-300 group-hover:brightness-110" style="height: {{ rand(15, 50) }}%"></div>
                            </div>
            ...
            <div class="col-span-12 lg:col-span-4 bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col justify-between">
                <div>
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-slate-800 font-bold text-lg">Piket Hari Ini</h3>
                        <span class="text-[10px] uppercase tracking-wider font-bold bg-amber-100 text-amber-700 px-2 py-1 rounded">Shift Pagi</span>
                    </div>

                    <div class="flex flex-col items-center text-center py-4">
                        <div class="relative mb-4">
                            <div class="absolute -inset-1 bg-gradient-to-tr from-[#D4AF37] to-[#1A305E] rounded-full opacity-25"></div>
                        ...
                        <div class="inline-flex items-center text-xs font-bold text-slate-600 bg-slate-100 px-4 py-2 rounded-full border border-slate-200">
                            <svg class="w-4 h-4 mr-2 text-[#1A305E]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            08:00 — 16:00 WITA
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-2 mt-6">
                    <button class="flex-1 py-2 px-4 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-600 text-sm font-semibold transition-colors border border-slate-200">
                        Kemarin
                    </button>
                    <button class="flex-1 py-2 px-4 rounded-xl bg-slate-800 hover:bg-slate-900 text-white text-sm font-semibold transition-colors shadow-sm">
                        Besok
                    </button>
                </div>
            </div>
