            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400">Berita terbaru yang memerlukan tinjauan
                            admin</p>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead>
                            <tr class="border-b border-slate-100 dark:border-slate-700">
                                <th class="pb-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Judul Berita
                                </th>
                                <th
                                    class="pb-4 text-xs font-bold text-slate-400 uppercase tracking-wider hidden lg:table-cell">
                                    SKPD Penginput</th>
                            ...
                            @forelse($pendingBerita as $berita)
                                <tr class="group hover:bg-slate-50 dark:hover:bg-slate-900/40 transition-colors">
                                    <td class="py-4 pr-4">
                                        <div class="flex items-start gap-3">
                                            <div
                                                class="mt-1 p-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg group-hover:bg-blue-100 transition-colors">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
