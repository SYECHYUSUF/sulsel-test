<x-admin-layout title="Manajemen Berita - Admin PPID">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
            <h3 class="text-lg font-bold text-[#1A305E]">Daftar Pengajuan Keberatan</h3>
        </div>
        ...
        <div class="p-4 bg-slate-50 border-b border-slate-100">
            <form action="{{ route('admin.permohonan-informasi.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
                <div class="relative flex-1 max-w-md">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari judul pengajuan..."
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form action="{{ route('admin.permohonan-informasi.destroy', $item->id_pengajuan) }}" method="POST"
