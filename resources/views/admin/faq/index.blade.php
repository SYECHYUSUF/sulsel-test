<x-admin-layout>
    ...
    <div x-data="faqDataTable()" x-init="fetchData()" class="space-y-6">
                                ...
                                <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <button type="button" @click="confirmDelete('/admin/faq/' + item.id_faq)"
        ...
        <x-confirmation-dialog trigger="deleteModalOpen" title="Hapus FAQ?"
            description="Apakah Anda yakin ingin menghapus FAQ ini?" confirmText="Ya, Hapus" theme="danger"
