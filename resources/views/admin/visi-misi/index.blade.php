<x-admin-layout>
    <x-slot:title>Visi Misi</x-slot:title>
    ...
    <div class="p-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 dark:text-white mb-2">Visi Misi</h1>
                    <p class="text-slate-600 dark:text-slate-400">Kelola konten halaman Visi Misi</p>
                </div>
            </div>
            ...
            <div x-data="{ showSuccess: {{ session('success') ? 'true' : 'false' }} }">
                    ...
                    <form action="{{ route('admin.visi-misi.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nm_profil"
                                value="{{ old('nm_profil', $profil->nm_profil ?? 'Visi Misi') }}"
                ...
                @if(isset($profil->deskripsi) && $profil->deskripsi)
                    <div
                        ...
                        <div class="prose prose-slate max-w-none dark:prose-invert prose-preview">
                            {!! $profil->deskripsi !!}
                        </div>
                    </div>
                @endif
