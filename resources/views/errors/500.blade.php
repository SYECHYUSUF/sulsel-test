<x-errors-layout>
    <x-slot:title>{{ '500 - ' . (app()->getLocale() == 'id' ? 'Kesalahan Server' : 'Server Error') }}</x-slot:title>

    <div class="relative z-10 flex items-center justify-center min-h-[calc(100vh-12rem)] px-4 py-12">
        <div class="max-w-4xl w-full text-center">
            <!-- 3D Illustration -->
            <div class="mb-8 animate-float">
                <img src="{{ asset('images/errors/500.png') }}" alt="500 Illustration"
            ...
            <div class="space-y-6">
                ...
                <p class="text-base md:text-lg text-slate-300 max-w-2xl mx-auto">
                    @if(app()->getLocale() == 'id')
                        Maaf, terjadi kesalahan pada server kami. Tim teknis kami telah diberi tahu dan sedang bekerja untuk
                        memperbaikinya. Silakan coba lagi nanti.
                    @else
                        Sorry, something went wrong on our server. Our technical team has been notified and is working to
                ...
                <div class="max-w-xl mx-auto mt-6 p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                    <p class="text-sm text-slate-200">
                        @if(app()->getLocale() == 'id')
                            <strong>Saran:</strong> Tunggu beberapa saat dan muat ulang halaman. Jika masalah berlanjut,
                            hubungi dukungan teknis kami.
                        @else
                            <strong>Suggestion:</strong> Wait a moment and reload the page. If the problem persists, contact
