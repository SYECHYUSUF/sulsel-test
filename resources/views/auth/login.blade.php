<x-app-layout>
    ...
    <div class="min-h-screen relative flex items-center justify-center p-4 lg:p-0 font-sans">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-[#1A305E]/95 via-[#1A305E]/85 to-[#122143]/95 mix-blend-multiply"></div>
        ...
        <div class="relative z-10 w-full max-w-[1100px] h-auto lg:h-[650px] bg-white rounded-3xl shadow-2xl border border-white/40 overflow-hidden flex flex-col lg:flex-row shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] animate-slide-up">
            ...
            <div class="hidden lg:flex lg:w-5/12 bg-gradient-to-b from-[#1A305E] to-[#0f172a] p-12 flex-col justify-between items-center text-center relative overflow-hidden group border-r border-white/10">
            ...
            <div class="w-full lg:w-7/12 bg-white relative flex flex-col justify-center h-full">
                ...
                <div class="lg:hidden absolute top-0 left-0 w-full p-6 flex justify-between items-start bg-gradient-to-b from-gray-50 to-white border-b border-gray-100/50">
                ...
                <div class="p-8 md:p-14 lg:p-16 w-full max-w-lg mx-auto flex flex-col justify-center h-full lg:mt-0 ">
                    <div class="mb-4 text-center lg:text-left">
                        <h1 class="text-3xl md:text-4xl font-extrabold text-[#1A305E] mb-1 tracking-tight">Selamat Datang</h1>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Email -->
                        <div class="space-y-2">
                            <label for="email" class="block text-sm font-bold text-[#1A305E] uppercase tracking-wider ml-1">Email</label>
                        ...
                        <div class="space-y-1" x-data="{ show: false }">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-[#1A305E] transition-colors">
                                ...
                                >
                                    ...
                                    <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye-icon lucide-eye"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/></svg>
                        ...
                        @if ($errors->any())
                            <div class="text-red-500 text-sm italic mb-4">
                                {{ $errors->first() }}
                            </div>
                        @endif

                        <button type="submit" class="w-full mt-4 flex justify-center py-4 px-6 border border-transparent rounded-xl shadow-lg text-base font-bold text-white bg-gradient-to-r from-[#1A305E] to-[#2c3e50] hover:from-[#122143] hover:to-[#1A305E] focus:outline-none focus:ring-4 focus:ring-[#1A305E]/30 transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                            MASUK SEKARANG
                        </button>
