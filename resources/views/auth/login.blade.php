<x-app-layout>
    <x-slot:title>Login - PPID Sulsel</x-slot:title>
    ...
    <div class="min-h-screen relative flex items-center justify-center p-4 lg:p-0 font-sans">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/kantor.jpeg') }}" alt="Kantor Gubernur"
            ...
            <div
                class="absolute inset-0 opacity-5 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMSIgY3k9IjEiIHI9IjEiIGZpbGw9InJnYmEoMjU1LDI1NSwyNTUpIi8+PC9zdmc+')]">
            </div>
        </div>

        <!-- Main Card Container: Glassmorphism + Firm Borders -->
        <div
            class="relative z-10 w-full max-w-[1100px] h-auto lg:h-[650px] bg-white rounded-3xl shadow-2xl border border-white/40 overflow-hidden flex flex-col lg:flex-row shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] animate-slide-up">
            ...
            <div
                ...
                <div class="relative z-10 w-full text-left">
                    <a href="{{ url('/') }}"
                        class="inline-flex items-center text-white/90 hover:text-white transition-all gap-2 group-hover:-translate-x-1 duration-300 font-medium">
                        <div
                            class="p-1.5 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-colors">
