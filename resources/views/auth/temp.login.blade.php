...
<div class="min-h-screen relative flex items-center justify-center p-4 lg:p-0 font-sans">
    ...
    <div class="relative z-10 w-full max-w-[1100px] h-auto lg:h-[650px] bg-white rounded-3xl shadow-2xl border border-white/40 overflow-hidden flex flex-col lg:flex-row shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] animate-slide-up">
        ...
        <div class="hidden lg:flex lg:w-5/12 bg-linear-to-b from-ppid-primary to-[#0f172a] p-12 flex-col justify-between items-center text-center relative overflow-hidden group border-r border-white/10">
            ...
            <div class="relative z-10 flex flex-col items-center mt-8">
                ...
                <h2 class="text-3xl font-bold text-white mb-2 tracking-tight leading-tight">PPID Utama<br><span class="text-ppid-accent">Sulawesi Selatan</span></h2>
        ...
        <div class="w-full lg:w-7/12 bg-white relative flex flex-col justify-center h-full">
            ...
            <div class="p-8 md:p-14 lg:p-16 w-full max-w-lg mx-auto flex flex-col justify-center h-full lg:mt-0 ">
                <div class="mb-8 lg:mb-10 text-center lg:text-left">
                    <h1 class="text-3xl md:text-4xl font-extrabold text-ppid-primary mb-3 tracking-tight">Selamat Datang</h1>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <!-- Username -->
                    <div class="space-y-2">
                        <label for="username" class="block text-sm font-bold text-ppid-primary uppercase tracking-wider ml-1">Username</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-ppid-primary transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <!-- Password -->
                    <div class="space-y-2">
                        <label for="password" class="block text-sm font-bold text-ppid-primary uppercase tracking-wider ml-1">Password</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-ppid-primary transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <input type="password" name="password" id="password" 
                                class="block w-full pl-11 pr-12 py-4 border-2 border-gray-200 rounded-xl bg-gray-50/50 text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-ppid-primary focus:ring-4 focus:ring-ppid-primary/10 transition-all duration-200 ease-out font-medium" 
                                placeholder="Masukkan password Anda" required>
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer">
                                <svg class="h-6 w-6 text-gray-400 hover:text-ppid-primary transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-ppid-primary uppercase tracking-wider ml-1">Keamanan</label>
                        <div class="flex gap-3">
                            <div class="w-5/12 bg-linear-to-r from-gray-100 to-gray-200 rounded-xl flex items-center justify-between px-4 py-3 border border-gray-300 select-none shadow-inner">
                                ...
                                <button type="button" class="text-gray-500 hover:text-ppid-primary p-1 rounded-full hover:bg-gray-200 transition-colors">
                            ...
                            <input type="text" 
                                class="w-7/12 px-4 py-3 border-2 border-gray-200 rounded-xl bg-gray-50/50 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-ppid-primary focus:ring-4 focus:ring-ppid-primary/10 transition-all font-medium" 
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <label class="flex items-center cursor-pointer group">
                            <input id="remember" name="remember" type="checkbox" class="w-5 h-5 text-ppid-primary bg-gray-100 border-gray-300 rounded focus:ring-ppid-primary focus:ring-2 transition duration-150 ease-in-out">
                            <span class="ml-3 block text-sm text-gray-600 font-medium group-hover:text-ppid-primary transition-colors">Ingat Saya</span>
                        </label>
                        <a href="#" class="text-sm font-bold text-ppid-primary hover:text-ppid-accent transition-colors hover:underline underline-offset-4">Lupa Password?</a>
                    </div>
