<x-layout>
    ...
    <div class="relative" x-data="{
                    ...
                    <div
                        ...
                        <form @submit.prevent="searchPermohonan" class="max-w-2xl mx-auto">
                            ...
                            <button type="submit" :disabled="loading"
                                ...
                                <span
                                    x-text="loading ? '{{ __('messages.status.searching') }}' : '{{ __('messages.status.check_my_status') }}'"></span>
                            </button>
                        </form>
                    </div>
                </div>
        ...
        {{-- Results Section --}}
        <section id="hasil-pencarian" x-show="permohonan.length > 0" x-cloak
                        ...
                        <div
                            ...
                            <div class="p-8 grid lg:grid-cols-2 gap-8">
                                ...
                                <template x-if="item.status != 5">
                                    ...
                                    <div class="space-y-6">
                                        <div
                                            class="bg-gradient-to-br from-ppid-primary to-ppid-primary-light rounded-2xl p-5 text-white shadow-lg">
                                            <p class="text-xs font-bold text-ppid-accent uppercase mb-1">
                                                {{ __('messages.status.handled_by') }}
                                            </p>
                                            <p class="text-lg font-bold"
                                                x-text="item.skpd ? item.skpd.nm_skpd : 'Admin PPID Sulsel'"></p>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <template x-if="disp.catatan_disposisi">
                                                        <div
                                                            ...
                                                            <p
                                                                class="text-xs font-semibold text-blue-800 dark:text-blue-300 mb-1">
                                                                Catatan Admin:</p>
                                                            <p class="text-sm text-blue-700 dark:text-blue-200"
                                                                x-text="disp.catatan_disposisi"></p>
                                                        </div>
                                                    </template>
                                                    ...
                                                    <template x-if="disp.respon && disp.respon.length > 0">
                                                        <div>
                                                            <template x-for="(resp, respIndex) in disp.respon"
                                                                :key="respIndex">
                                                                <div
                                                                    class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-xl p-4 mb-2">
                                                                    <p
                                                                        class="text-xs font-semibold text-green-800 dark:text-green-300 mb-2">
                                                    ...
                                                    <template x-if="!disp.respon || disp.respon.length === 0">
                                                        <p class="text-slate-500 dark:text-slate-400 italic text-sm">
                                                            Belum ada respon dari SKPD ini.</p>
                                                    </template>
                                                </div>
                                            </template>
                                        </div>
