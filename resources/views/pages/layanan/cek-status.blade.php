<x-layout>
    ...
    <div class="relative" x-data="{
        ...
        {{-- Hero Section --}}
        <section class="relative bg-gradient-to-br from-ppid-primary via-[#2a4a7c] to-ppid-primary text-white overflow-hidden pb-32 md:pb-40">
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-gradient-to-br from-white via-slate-50 to-blue-50/30 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 rounded-[2.5rem] shadow-2xl p-8 md:p-14 border-2 border-ppid-primary/10 dark:border-blue-500/30">
                        ...
                        <form @submit.prevent="searchStatus" class="max-w-2xl mx-auto">
                            ...
                            <button type="submit" :disabled="loading" class="w-full bg-gradient-to-r from-ppid-primary to-[#2a4a7c] hover:from-[#152749] hover:to-[#1f3a65] text-white text-xl md:text-2xl font-bold py-6 px-8 rounded-2xl transition-all transform hover:scale-[1.02] shadow-xl flex items-center justify-center gap-4 disabled:opacity-50">
