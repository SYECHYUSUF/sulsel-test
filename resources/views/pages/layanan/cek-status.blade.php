                        ...
                        <div class="mb-10">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <button type="button" @click="type = 'permohonan'; resetForm()"
                                    :class="type === 'permohonan' ? 'bg-gradient-to-r from-[#1A305E] to-[#2a4a7c] text-white shadow-xl scale-105' : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:shadow-lg'"
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="p-3 rounded-xl transition-colors" :class="type === 'permohonan' ? 'bg-white/10' : 'bg-slate-100 dark:bg-slate-600'">
                                            <svg class="w-8 h-8 transition-colors" :class="type === 'permohonan' ? 'text-[#D4AF37]' : 'text-[#1A305E] dark:text-slate-300'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button type="button" @click="type = 'keberatan'; resetForm()"
                                    :class="type === 'keberatan' ? 'bg-gradient-to-r from-[#1A305E] to-[#2a4a7c] text-white shadow-xl scale-105' : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:shadow-lg'"
                                    class="relative p-6 rounded-2xl border-2 transition-all duration-300 group"
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="p-3 rounded-xl transition-colors" :class="type === 'keberatan' ? 'bg-white/10' : 'bg-slate-100 dark:bg-slate-600'">
                                            <svg class="w-8 h-8 transition-colors" :class="type === 'keberatan' ? 'text-[#D4AF37]' : 'text-[#1A305E] dark:text-slate-300'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="container mx-auto px-4 sm:px-6">
                <div class="text-center mb-12">
                    <div class="inline-flex flex-col sm:flex-row items-center gap-4 bg-white dark:bg-slate-800 px-8 py-5 rounded-2xl shadow-lg border-2 border-[#1A305E]/10">
                        ...
                        <span class="bg-[#D4AF37] text-white px-4 py-1 rounded-full text-sm font-bold" x-text="results.length + ' Data'"></span>
                    </div>
                </div>
