    ...
    <div class="bg-white border-b border-gray-200 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] font-bold">SOP</span>
            </div>
    ...
    <main class="py-12 md:py-16 bg-gray-50 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4">
            <div class="max-w-7xl mx-auto">
                ...
                {{-- Search Box --}}
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-8 max-w-2xl">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @foreach ($sopData as $sop)
                                    <tr class="hover:bg-blue-50/50 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 text-gray-800 font-medium group-hover:text-[#1A305E] transition-colors">{{ $sop['judul'] }}</td>
                                        <td class="px-6 py-4">
                                             <div class="flex items-center justify-center gap-3">
                                                 <button class="p-2 text-gray-400 hover:text-[#1A305E] hover:bg-gray-100 rounded-lg transition-all" title="Lihat">
                                                 ...
                                                 <button class="flex items-center gap-1.5 px-3 py-1.5 bg-[#1A305E]/5 text-[#1A305E] rounded-lg hover:bg-[#1A305E] hover:text-white transition-all text-xs font-bold" title="Download">
