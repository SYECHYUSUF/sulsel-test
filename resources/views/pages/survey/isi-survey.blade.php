    ...
    <div class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 font-['Plus_Jakarta_Sans'] ">
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] dark:text-white font-medium">{{ __('messages.survey_pages.isi_title') }}</span>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                ...
                <div class="border-b border-gray-200 dark:border-slate-700 pb-6 mb-8">
                    <h2 class="text-2xl font-bold text-[#1A305E] dark:text-white mb-3">{{ __('messages.survey_form.form_title') }}</h2>
                ...
                <form method="POST" action="/survey/isi-survey" class="space-y-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-white dark:from-slate-900 dark:to-slate-800 p-8 rounded-2xl border-2 border-gray-200 dark:border-slate-700 shadow-sm">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <h3 class="text-xl font-bold text-[#1A305E] dark:text-white">{{ __('messages.survey_form.respondent_data') }}</h3>
                        </div>
                        <div class="space-y-5">
                            <div class="space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="nama" placeholder="{{ __('messages.form.full_name') }}" required class="w-full px-5 py-3.5 text-base rounded-xl border-2 border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-[#1A305E] focus:border-[#1A305E] outline-none transition-all bg-white dark:bg-slate-800 dark:text-white" value="{{ old('nama') }}" />
                                @error('nama')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="space-y-2">
                                ...
                                <input type="text" name="lembaga" placeholder="{{ __('messages.survey_form.institution_placeholder') }}" required class="w-full px-5 py-3.5 text-base rounded-xl border-2 border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-[#1A305E] focus:border-[#1A305E] outline-none transition-all bg-white dark:bg-slate-800 dark:text-white" value="{{ old('lembaga') }}" />
                                @error('lembaga')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="space-y-2">
                                ...
                                <textarea rows="3" name="alamat" placeholder="{{ __('messages.form.applicant_address') }}" required class="w-full px-5 py-3.5 text-base rounded-xl border-2 border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-[#1A305E] focus:border-[#1A305E] outline-none transition-all bg-white dark:bg-slate-800 dark:text-white resize-none">{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-white dark:from-slate-900 dark:to-slate-800 p-8 rounded-2xl border-2 border-gray-200 dark:border-slate-700 shadow-sm">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <h3 class="text-xl font-bold text-[#1A305E] dark:text-white">{{ __('messages.survey_form.service_rating') }}</h3>
                        </div>
                                    ...
                                    @if($question->tipe == 'radio')
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-200 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group">
                                                ...
                                                <span class="text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-[#1A305E] dark:group-hover:text-white transition-colors">A. {{ __('messages.survey_form.very_good') }}</span>
                                            </label>
                                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-200 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group">
                                                ...
                                                <span class="text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-[#1A305E] dark:group-hover:text-white transition-colors">B. {{ __('messages.survey_form.good') }}</span>
                                            </label>
                                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-200 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group">
                                                ...
                                                <span class="text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-[#1A305E] dark:group-hover:text-white transition-colors">C. {{ __('messages.survey_form.fair') }}</span>
                                            </label>
                                            <label class="relative flex items-center gap-3 p-4 rounded-lg border-2 border-gray-200 dark:border-slate-600 cursor-pointer hover:border-[#1A305E] hover:bg-blue-50 dark:hover:bg-slate-700 transition-all group">
                                                ...
                                                <span class="text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-[#1A305E] dark:group-hover:text-white transition-colors">D. {{ __('messages.survey_form.poor') }}</span>
                                            </label>
                                        </div>
                                    @elseif($question->tipe == 'textarea')
                                        <textarea rows="5" name="answer[{{ $question->id }}]" placeholder="{{ __('messages.survey_form.comment_placeholder') }}" class="w-full px-5 py-3.5 text-base rounded-xl border-2 border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-[#1A305E] focus:border-[#1A305E] outline-none transition-all bg-white dark:bg-slate-800 dark:text-white resize-none">{{ old('answer.' . $question->id) }}</textarea>
                                    @endif
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 p-8 rounded-2xl border-2 border-gray-200 dark:border-slate-700 shadow-sm">
                        ...
                        <textarea rows="5" name="masukan" placeholder="{{ __('messages.survey_form.feedback_placeholder') }}" class="w-full px-5 py-3.5 text-base rounded-xl border-2 border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-[#1A305E] focus:border-[#1A305E] transition-all outline-none bg-white dark:bg-slate-800 dark:text-white resize-none">{{ old('masukan') }}</textarea>
                    </div>
