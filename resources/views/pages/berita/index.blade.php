                    ...
                    <div>
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex gap-4 text-sm font-medium">
                                ...
                                <a href="#" class="text-gray-500 hover:text-[#1A305E] dark:text-gray-400 dark:hover:text-white">{{ __('messages.common.official_news') }}</a>
                            </div>
                        </div>
                                                        ...
                                                        <article class="group flex flex-col h-full bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                                                            ...
                                                            <div class="p-5 flex-1 flex flex-col">
                                                                ...
                                                                <a href="/berita/detail" class="block mb-3">
                                                                    <h3 class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-[#1A305E] dark:group-hover:text-[#D4AF37] transition-colors line-clamp-2 leading-tight">
                                                                        {{ $news['title'] }}
                                                                    </h3>
                                                                </a>
                                                    ...
                                                    <div class="space-y-2">
                                                        ...
                                                        $categories = [
                                                            ...
                                                            @foreach($categories as $cat)
                                                                <a href="#" class="flex items-center justify-between p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors group">
