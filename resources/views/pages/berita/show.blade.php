                ...
                <div class="lg:col-span-8 bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-10 shadow-sm border border-gray-100">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="bg-[#1A305E] text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">Siaran Pers</span>
                        ...
                        <div class="rounded-xl overflow-hidden mb-2">
                             <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2664&auto=format&fit=crop" class="w-full h-auto object-cover" alt="Article Image">
                        </div>
                        <p class="text-sm text-gray-500 italic text-center">Menteri Komunikasi dan Digital saat memberikan sambutan pada acara Transformasi Digital Indonesia.</p>
                    </div>
                    ...
                    <div class="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        <p class="mb-5">
                            Dalam forum Digital Leaders Summit 2026, Menkomdigi menyoroti pentingnya keterampilan digital yang inklusif. Menurutnya, tanpa pemerataan kemampuan digital, kemajuan teknologi justru berpotensi memperlebar jurang kesenjangan sosial dan ekonomi di masyarakat.
                        </p>
                        ...
                        <p class="mb-5">
                            Selain itu, kolaborasi lintas sektor antara pemerintah, swasta, dan komunitas juga dinilai krusial. Program mentoring digital untuk UMKM dan pelatihan coding untuk anak-anak muda di daerah terpencil menjadi salah satu prioritas utama tahun ini.
                        </p>

                        <p>
                            Menutup sambutannya, Menkomdigi mengajak seluruh pemangku kepentingan untuk bersinergi mewujudkan visi Indonesia Emas 2045 melalui ekosistem digital yang adil, aman, dan produktif.
                        </p>
                    </div>
                    ...
                    <div class="mt-12 pt-8 border-t border-gray-100 dark:border-transparent">
                        <div class="flex flex-wrap items-center justify-between gap-6">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button class="w-8 h-8 rounded-full bg-sky-100 text-sky-500 flex items-center justify-center hover:bg-sky-500 hover:text-white transition-colors">
                                ...
                                <button class="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center hover:bg-green-600 hover:text-white transition-colors">
