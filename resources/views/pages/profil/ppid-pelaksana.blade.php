                    ...
                    <form @submit.prevent="performSearch()" class="max-w-2xl mx-auto">
                        <div class="relative bg-white dark:bg-slate-800 rounded-xl shadow-lg hover:shadow-xl border-2 border-[#1A305E]/20 dark:border-slate-700 hover:border-[#D4AF37]/50 transition-all duration-300">
                            <div class="flex items-center gap-2 p-2">
                                ...
                                <button type="submit"
                                        :disabled="loading"
                                        class="flex items-center gap-2 px-5 py-3 bg-[#1A305E] hover:bg-[#D4AF37] text-white rounded-lg transition-all duration-300 font-medium shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" :class="{'opacity-50 pointer-events-none': loading}">
                    <template x-for="skpd in skpds" :key="skpd.id_skpd">
                        <a :href="`/ppid-pelaksana/${skpd.id_skpd}`" 
                           class="group relative bg-white dark:bg-slate-800 rounded-2xl shadow-md hover:shadow-2xl border-2 border-gray-100 dark:border-slate-700 hover:border-[#D4AF37] p-8 transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col h-full">
                            ...
                            <div class="text-center space-y-4 flex flex-col flex-grow">
                                ...
                                <div class="min-h-[3.5rem] flex items-center justify-center">
                                    <h3 class="text-lg md:text-xl font-bold text-[#1A305E] dark:text-white leading-tight group-hover:text-[#D4AF37] transition-colors duration-300" x-text="skpd.nm_skpd"></h3>
                                </div>
