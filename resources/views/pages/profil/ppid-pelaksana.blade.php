    ...
    <div class="bg-white border-b border-gray-200 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] font-bold">PPID Pelaksana</span>
            </div>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($ppidData as $ppid)
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-xl transition-all hover:border-[#D4AF37]/30 group hover:-translate-y-1 relative overflow-hidden">
                            ...
                            <div class="flex justify-center mb-6 relative z-10">
                                <div class="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center shadow-inner group-hover:bg-white transition-colors">
                                     <img src="{{ asset('images/logo-sulsel.png') }}" alt="Logo Sulsel" class="w-14 h-14 object-contain">
                                </div>
                            </div>

                            {{-- Name --}}
                            <h3 class="text-center font-bold text-[#1A305E] mb-6 text-base leading-snug min-h-[50px] flex items-center justify-center">
                                {{ $ppid['name'] }}
                            </h3>

                            {{-- Divider --}}
                            <div class="w-full h-px bg-gray-100 mb-6 group-hover:bg-[#D4AF37]/20 transition-colors"></div>

                            {{-- Contact Info --}}
                            <div class="space-y-4 text-sm text-gray-600">
                                <div class="flex items-start gap-3">
                                   <div class="w-8 h-8 rounded-lg bg-blue-50 text-[#1A305E] flex items-center justify-center flex-shrink-0 mt-0.5">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                                   </div>
                                    <div>
                                        <p class="font-bold text-[#1A305E] text-xs uppercase mb-0.5">Alamat</p>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-[#1A305E] text-xs uppercase mb-0.5">Telepon</p>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="font-bold text-[#1A305E] text-xs uppercase mb-0.5">Email</p>
                                        <a href="mailto:{{ $ppid['email'] }}" class="text-[#1A305E] hover:underline break-all group-hover:text-[#D4AF37] transition-colors text-xs truncate block">
                                            {{ $ppid['email'] }}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="font-bold text-[#1A305E] text-xs uppercase mb-0.5">Website</p>
                                        <a href="{{ $ppid['website'] }}" target="_blank" rel="noopener noreferrer" class="text-[#1A305E] hover:underline break-all group-hover:text-[#D4AF37] transition-colors text-xs truncate block">
                                            {{ $ppid['website'] }}
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="mt-12 flex items-center justify-center gap-2">
                    ...
                    <button class="w-10 h-10 flex items-center justify-center bg-white text-gray-700 rounded-lg hover:bg-gray-50 border border-gray-200 transition-all font-medium">2</button>
                    <button class="w-10 h-10 flex items-center justify-center bg-white text-gray-700 rounded-lg hover:bg-gray-50 border border-gray-200 transition-all font-medium">3</button>
                    <span class="px-2 text-gray-400">...</span>
                    <button class="w-10 h-10 flex items-center justify-center bg-white text-gray-700 rounded-lg hover:bg-gray-50 border border-gray-200 transition-all font-medium">7</button>
                </div>
