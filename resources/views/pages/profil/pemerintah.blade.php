    ...
    <div class="bg-white border-b border-gray-200 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] font-medium">Profil Pemerintah Sulsel</span>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-10 max-w-5xl mx-auto">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                    <div class="w-12 h-12 bg-[#1A305E]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 text-[#1A305E]"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                    </div>
                    <p class="text-2xl font-bold text-[#1A305E] mb-1">46.717,48 km²</p>
                    <p class="text-sm text-gray-600">Luas Wilayah</p>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                    <div class="w-12 h-12 bg-[#1A305E]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 text-[#1A305E]"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    </div>
                    <p class="text-2xl font-bold text-[#1A305E] mb-1">9,07 Juta Jiwa</p>
                    <p class="text-sm text-gray-600">Jumlah Penduduk</p>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                    <div class="w-12 h-12 bg-[#1A305E]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 text-[#1A305E]"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>
                    </div>
                    <p class="text-2xl font-bold text-[#1A305E] mb-1">24 Wilayah</p>
            ...
            <div class="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                        <div class="mb-5">
                            <h2 class="text-2xl font-bold text-[#1A305E] mb-2">Profil Provinsi</h2>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                        <div class="mb-5">
                            <h2 class="text-2xl font-bold text-[#1A305E] mb-2">Data Geografis</h2>
                            ...
                            @foreach ($geografisData as $item)
                                <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900 text-sm">{{ $item['value'] }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                        <div class="mb-5">
                            <h2 class="text-2xl font-bold text-[#1A305E] mb-2">Visi & Misi</h2>
                            <div class="w-20 h-1 bg-[#1A305E] rounded-full"></div>
                        </div>
                
                        {{-- Visi --}}
                        <div class="mb-6">
                            <h3 class="font-bold text-[#1A305E] mb-3 text-sm uppercase tracking-wide">Visi</h3>
                        ...
                        {{-- Misi --}}
                        <div>
                            <h3 class="font-bold text-[#1A305E] mb-3 text-sm uppercase tracking-wide">Misi</h3>
                            <div class="space-y-3">
                                @php
                                    $misi = [
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden sticky top-24">
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="bg-[#1A305E]/5 rounded-lg p-4 border border-[#1A305E]/10">
                                <div class="aspect-[3/4] rounded-lg overflow-hidden mb-3 bg-white">
                                    <img 
                                ...
                                <p class="font-bold text-[#1A305E] text-sm">Andi Sudirman Sulaiman</p>
                            ...
                            <div class="bg-[#D4AF37]/5 rounded-lg p-4 border border-[#D4AF37]/20">
                                ...
                                <p class="font-bold text-[#1A305E] text-sm">Fatmawati Rusdi</p>
