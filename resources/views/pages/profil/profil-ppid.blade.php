    ...
    <div class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] dark:text-white font-medium">Profil PPID</span>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6 md:p-8">
                        <div class="flex items-start gap-4 mb-5">
                            <div class="w-12 h-12 bg-[#1A305E]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6 text-[#1A305E] dark:text-white"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                            </div>
                            <div>
                                <h2 class="text-xl font-bold text-[#1A305E] dark:text-white mb-1">Tentang PPID Sulawesi Selatan</h2>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6 md:p-8">
                        <div class="flex items-start gap-4 mb-5">
                            ...
                            <div>
                                <h2 class="text-xl font-bold text-[#1A305E] dark:text-white mb-1">Tugas dan Fungsi PPID</h2>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div class="bg-[#1A305E]/5 rounded-lg p-5 border border-[#1A305E]/10">
                                <h3 class="font-bold text-[#1A305E] dark:text-white mb-3 text-sm">Tugas Utama</h3>
                                <ul class="space-y-2 text-sm text-gray-700">
                                    <li class="flex gap-2">
                                        <span class="text-[#1A305E] dark:text-white mt-0.5">•</span>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
                        <h3 class="font-bold text-[#1A305E] dark:text-white mb-4 text-sm uppercase tracking-wide">Prinsip Layanan</h3>
                        <div class="space-y-4">
                            <div class="flex gap-3 items-start">
                                <div class="w-10 h-10 bg-[#1A305E]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-[#1A305E] dark:text-white"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-sm mb-0.5">Transparansi</h4>
                                    <p class="text-xs text-gray-600 dark:text-gray-300">Keterbukaan informasi publik untuk masyarakat</p>
                                </div>
                            </div>
                            <div class="flex gap-3 items-start">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-sm mb-0.5">Akuntabilitas</h4>
                                    <p class="text-xs text-gray-600 dark:text-gray-300">Pengelolaan informasi yang bertanggung jawab</p>
                                </div>
                            </div>
                            <div class="flex gap-3 items-start">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-sm mb-0.5">Profesional</h4>
                                    <p class="text-xs text-gray-600 dark:text-gray-300">Layanan prima untuk seluruh masyarakat</p>
                                </div>
                            </div>
                        </div>
                    </div>
