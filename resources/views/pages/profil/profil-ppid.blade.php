    ...
    <div class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 mb-4">
                ...
                <span class="text-ppid-primary dark:text-white font-medium">{{ __('messages.profile.ppid_title') }}</span>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8 mb-12 max-w-6xl mx-auto">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <h3 class="font-bold text-ppid-primary dark:text-white mb-4 text-sm uppercase tracking-wide">
                            Prinsip Layanan</h3>
                        <div class="space-y-4">
                            <div class="flex gap-3 items-start">
                                <div
                                    class="w-10 h-10 bg-ppid-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="w-5 h-5 text-ppid-primary dark:text-white">
                            ...
                            <div class="flex gap-3 items-start">
                                <div
                                    class="w-10 h-10 bg-ppid-text/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="w-5 h-5 text-ppid-text">
                            ...
                            <div class="flex gap-3 items-start">
                                <div
                                    class="w-10 h-10 bg-ppid-accent/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="w-5 h-5 text-ppid-accent">
                    ...
                    {{-- Landasan Hukum --}}
                    <div class="bg-ppid-primary text-white rounded-xl shadow-sm p-6">
                        <h3 class="font-bold mb-4 text-sm uppercase tracking-wide">Landasan Hukum</h3>
                        <div class="space-y-3 text-sm">
                            <div class="flex gap-2 items-start">
                                <div class="w-1.5 h-1.5 bg-ppid-accent rounded-full mt-2 flex-shrink-0"></div>
