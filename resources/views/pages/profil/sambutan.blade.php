<x-layout>
    ...
    <div class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-6">
            ...
            <span class="text-[#1A305E] dark:text-white font-medium">{{ __('messages.profile.greeting_title') }}</span>
        </div>
        ...
        <div>
            <div>
                <h1 class="text-3xl md:text-4xl font-extrabold text-[#1A305E] dark:text-white leading-tight">{{ __('messages.profile.greeting_title') }}</h1>
                <p class="text-base md:text-lg text-gray-600 dark:text-gray-300 mt-2">{{ __('messages.profile.greeting_subtitle') }}</p>
            </div>
        </div>
