            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="border-t border-gray-200 dark:border-slate-700 px-6 py-4 bg-gray-50 dark:bg-slate-900 flex items-center justify-center gap-2">
                         ...
                         <button class="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 text-gray-700 border border-gray-200 dark:border-slate-700 rounded hover:bg-gray-100 dark:bg-slate-700">28</button>
                    </div>
                </div>
