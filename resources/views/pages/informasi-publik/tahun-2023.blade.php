        ...
        <div class="container mx-auto px-4">
            <div class="max-w-7xl mx-auto space-y-10">
                ...
                <section>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-b-xl shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    @foreach ($berkalaData as $item)
                                        <tr class="hover:bg-[#1A305E]/5 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['waktu'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['bentuk'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['jangkaWaktu'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['jenisMedia'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['biaya'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    @foreach ($setiapSaatData as $item)
                                        <tr class="hover:bg-gray-100 dark:bg-slate-700 transition-colors">
                                            <td class="px-4 py-3 text-sm text-gray-700">{{ $item['jenis'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-700">{{ $item['ringkasan'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-700">{{ $item['pejabat'] }}</td>
                                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $item['waktu'] }}</td>
