    ...
    <div class="bg-white border-b border-gray-200 font-['Plus_Jakarta_Sans']">
        <div class="container mx-auto px-4 py-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                ...
                <a href="/informasi-publik" class="hover:text-[#1A305E] transition-colors">Barang Dan Jasa</a>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-400"><path d="m9 18 6-6-6-6"/></svg>
                <span class="text-[#1A305E] font-medium">Informasi Pengadaan</span>
            </div>
          
            {{-- Title --}}
            <div class="flex items-end justify-between">
                <div>
                    <h1 class="text-2xl md:text-4xl font-bold text-[#1A305E] mb-2">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                    ...
                                    <tr class="hover:bg-[#1A305E]/5 transition-colors">
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-xs font-bold text-[#1A305E] bg-[#1A305E]/10 px-2 py-0.5 rounded">
                                                    481
                                                </span>
                                            </div>
                                        </td>
                    ...
                    <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 flex items-center justify-center gap-2">
                         ...
                         <button class="w-8 h-8 flex items-center justify-center bg-white text-gray-700 border border-gray-200 rounded hover:bg-gray-100">18</button>
                    </div>
                </div>
