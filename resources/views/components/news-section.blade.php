<section class="py-12 md:py-[89px] bg-white font-['Plus_Jakarta_Sans'] transition-all">
    <div class="container mx-auto px-4">
        
        {{-- Section Header --}}
        <div class="text-center mb-10 md:mb-[55px] max-w-3xl mx-auto" data-aos="fade-down">
            <div class="inline-flex items-center gap-2 mb-[13px] px-4 py-1.5 md:px-5 md:py-2 bg-white border border-[#D4AF37]/30 rounded-full shadow-sm">
                <span class="w-2 h-2 bg-[#D4AF37] rounded-full animate-pulse"></span>
                <span class="text-[#1A305E] text-[9px] md:text-[10px] font-black uppercase tracking-widest">Berita Terkini</span>
            </div>
            <h2 class="text-2xl md:text-[42px] font-extrabold text-[#1A305E] mb-4 md:mb-[21px] leading-tight tracking-tight">
                Informasi & Berita Terbaru
            </h2>
            <p class="text-base md:text-lg text-[#4A5568]">Update terbaru seputar layanan informasi publik di Sulawesi Selatan</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-[34px] max-w-7xl mx-auto">
            ...
            <div data-aos="fade-up" data-aos-delay="{{ $index * 150 }}" class="group bg-white rounded-[21px] overflow-hidden border border-gray-100 shadow-sm hover:shadow-[0_20px_50px_-10px_rgba(26,48,94,0.15)] transition-all duration-500 hover:-translate-y-2 flex flex-col">
                ...
                <div class="p-6 md:p-[34px] flex-grow flex flex-col">
                    <div class="flex items-center gap-2 text-[#4A5568] text-xs mb-3 md:mb-[13px] font-semibold">
                    ...
                    <h3 class="text-lg md:text-[21px] font-bold text-[#1A305E] mb-6 md:mb-[21px] leading-snug group-hover:text-[#D4AF37] transition-colors line-clamp-2">
                        {{ $item['title'] }}
                    </h3>
                    
                    <div class="mt-auto">
                        <a href="#" class="inline-flex items-center gap-2 text-[#1A305E] font-bold text-sm group/btn hover:text-[#D4AF37] transition-colors">
