            ...
            <ul class="flex flex-col lg:flex-row items-stretch justify-center lg:items-center text-xs lg:text-sm font-medium text-white/90">
                ...
                <li class="lg:hidden px-6 py-4 border-b border-white/10">
                    <form action="/search" method="GET" class="relative">
                        <input 
                            type="text" 
                            name="query" 
                            placeholder="{{ __('messages.common.search_info') }}" 
                ...
                <li class="relative border-b lg:border-none border-white/10 group"
                    ...
                    <ul x-show="openProfil" 
                        ...
                        <li><a href="/profil-ppid" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.ppid_profile') }}</a></li>
                        <li><a href="/sambutan" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.greeting') }}</a></li>
                        <li><a href="/struktur-organisasi" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.org_structure') }}</a></li>
                        <li><a href="/visi-misi" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.vision_mission') }}</a></li>
                        <li><a href="/tupoksi" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.duties_functions') }}</a></li>
                        <li><a href="/maklumat-pelayanan" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.service_declaration') }}</a></li>
                        <li><a href="/profil-pemprov" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] transition-colors border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.government_profile') }}</a></li>
                    </ul>
                </li>
                ...
                <li class="relative border-b lg:border-none border-white/10 group"
                    ...
                    <ul x-show="openDaftar" 
                        ...
                        x-transition:leave-end="opacity-0 -translate-y-2 scale-95"
                        class="lg:absolute lg:left-0 lg:top-full w-full lg:w-64 bg-white dark:bg-slate-800 lg:shadow-xl text-[#1A305E] dark:text-gray-200 py-2 lg:rounded-b-lg lg:border-t-4 lg:border-[#D4AF37] z-50">
                        <li><a href="/informasi-publik/2023" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.data_info_2023') }}</a></li>
                        <li><a href="/informasi-publik/2024" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.data_info_2024') }}</a></li>
                        <li><a href="/informasi-publik/2025" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.data_info_2025') }}</a></li>
                        <li><a href="/informasi-publik/pengadaan" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.procurement_info') }}</a></li>
                    </ul>
                </li>
                ...
                <li class="relative border-b lg:border-none border-white/10 group"
                    ...
                    <ul x-show="openInformasi" 
                        ...
                        <li><a href="/informasi-publik/serta-merta" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.immediate_info') }}</a></li>
                        <li><a href="/informasi-publik/setiap-saat" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.anytime_info') }}</a></li>
                        <li><a href="/informasi-publik/dikecualikan" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.excluded_info') }}</a></li>
                        <li><a href="/informasi-publik" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.public_info_list') }}</a></li>
                        <li><a href="/informasi-publik/berkala" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.periodic_info') }}</a></li>
                    </ul>
                </li>
            ...
            {{ __('messages.menu.sop') }}
                ...
                <li class="relative border-b lg:border-none border-white/10 group"
                    ...
                    <ul x-show="openService" 
                        ...
                        <li><a href="/survey/isi-survey" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.fill_survey') }}</a></li>
                        <li><a href="/survey/hasil-survey" class="block px-10 lg:px-6 py-3 hover:bg-[#1A305E]/5 hover:text-[#D4AF37] border-l-4 border-transparent hover:border-[#D4AF37]">{{ __('messages.menu.survey_results') }}</a></li>
                    </ul>
                </li>
