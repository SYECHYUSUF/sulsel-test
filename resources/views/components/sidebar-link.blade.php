...
@php
    // Definisi class untuk efek smooth corner (inverted border radius)
...
<li>
    <a href="{{ $href }}" {{ $attributes->merge(['class' => "relative flex items-center px-6 py-3.5 text-sm font-medium transition-all duration-200 $classes"]) }}>
