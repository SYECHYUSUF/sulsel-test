<section 
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div class="text-center mb-12 sm:mb-16 md:mb-20" data-aos="fade-down">
            <span class="text-ppid-accent font-bold tracking-[0.2em] text-[10px] uppercase mb-3 block">{{ __('messages.leadership.badge') }}</span>
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-ppid-primary dark:text-white mb-4 tracking-tight">{{ __('messages.leadership.title') }}</h2>
        ...
        <div class="flex md:grid justify-center gap-6 md:gap-12 w-full md:max-w-4xl mx-auto pb-4 md:pb-0 md:grid-cols-2 px-4 md:px-0">
            ...
            <div data-aos="fade-up" data-aos-delay="{{ $index * 200 }}" class="flex flex-col group min-w-[200px] md:min-w-0 snap-start">
                ...
                <div class="relative aspect-[4/5] w-full rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-slate-700 transition-all duration-700 group-hover:shadow-xl group-hover:shadow-[rgba(26,48,94,0.15)] group-hover:-translate-y-1">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-ppid-primary/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20"></div>
                    ...
                    <div class="absolute bottom-6 left-6 z-30 flex gap-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                        <a href="#" class="w-9 h-9 bg-white/20 backdrop-blur-md border border-white/30 text-white rounded-xl flex items-center justify-center hover:bg-ppid-accent hover:border-ppid-accent transition-all transform hover:scale-110">
                ...
                <div class="mt-4 sm:mt-5 text-center md:text-left md:pl-2">
                    <h3 class="text-lg md:text-xl font-bold text-ppid-primary dark:text-white mb-0.5 tracking-tight group-hover:text-ppid-accent transition-colors">
                        {{ __($l['name']) }}
                    </h3>
