<section class="py-12 md:py-24 bg-gradient-to-br from-gray-50 via-violet-50/30 to-gray-50 relative overflow-hidden font-['Plus_Jakarta_Sans']">
    ...
    <div class="container mx-auto px-6 md:px-4 relative z-10">
        ...
        <div class="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
            ...
            <h2 class="text-2xl sm:text-3xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">Proses Permohonan Informasi</h2>
            <p class="text-base md:text-xl text-gray-600 leading-relaxed">4 langkah mudah untuk mendapatkan informasi publik yang Anda butuhkan</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 relative">
                ...
                @php
                    $steps = [
                        [
                            'n' => '1', 
                            'title' => 'Isi Formulir', 
                            'desc' => 'Lengkapi formulir permohonan informasi dengan data yang valid', 
                            'dur' => 'Instant', 
                            'col' => 'from-violet-500 to-purple-600',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg>'
                        ],
                        [
                            'n' => '2', 
                            'title' => 'Verifikasi', 
                            'desc' => 'Tim kami akan memverifikasi kelengkapan dokumen Anda', 
                            'dur' => '1-2 Hari', 
                            'col' => 'from-blue-500 to-cyan-600',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751A11.959 11.959 0 0 1 12 2.714Z" /></svg>'
                        ],
                        [
                            'n' => '3', 
                            'title' => 'Proses', 
                            'desc' => 'Permohonan diproses sesuai kategori informasi yang diminta', 
                            'dur' => '3-7 Hari', 
                            'col' => 'from-fuchsia-500 to-pink-600',
                        ...
                        [
                            'n' => '4', 
                            'title' => 'Terima Informasi', 
                            'desc' => 'Informasi siap diunduh atau diambil sesuai pilihan Anda', 
                            'dur' => 'Instant', 
                            'col' => 'from-green-500 to-emerald-600',
                ...
                <div class="relative">
                    <div class="bg-white rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-violet-200 group hover:-translate-y-2">
                        ...
                        <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-3">{{ $s['title'] }}</h3>
                        <p class="text-sm md:text-base text-gray-600 leading-relaxed mb-4">{{ $s['desc'] }}</p>
                        
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-full">
                            <svg class="w-4 h-4 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs md:text-sm font-semibold text-gray-700">{{ $s['dur'] }}</span>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="inline-flex flex-col sm:flex-row items-center gap-3 px-6 py-4 md:px-8 bg-white rounded-2xl shadow-lg border border-violet-200">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm md:text-base text-gray-700">
                            <strong class="text-violet-900">Total Waktu Proses:</strong> 
