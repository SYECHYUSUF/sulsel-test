            ...
            <a href="{{ $card['url'] }}" 
               ...
               class="group bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-lg hover:shadow-[0_20px_50px_-10px_rgba(26,48,94,0.15)] transition-all duration-300 border border-gray-100 dark:border-slate-700 hover:border-[#D4AF37]/50 flex flex-col h-full hover:-translate-y-2">
                ...
                <div class="flex flex-row md:flex-col">
                    ...
                    <div class="bg-[#1A305E] p-4 md:p-5 lg:p-6 relative overflow-hidden text-white group-hover:bg-[#15264a] transition-colors flex-shrink-0">
                        ...
                        <div class="relative w-10 h-10 md:w-14 md:h-14 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-2 md:mb-4 transition-transform group-hover:scale-110 border border-white/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="text-[#D4AF37] md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                {!! $card['icon'] !!}
                            </svg>
                        </div>
                        <div class="flex items-center gap-1.5 md:gap-2 text-white/70 text-[9px] md:text-xs font-semibold uppercase tracking-wider">
                            <span class="bg-[#D4AF37]/20 px-1.5 md:px-2 py-0.5 rounded text-[#D4AF37] whitespace-nowrap">{{ $card['badge'] }}</span>
                    ...
                    <div class="p-4 md:p-5 lg:p-8 flex flex-col flex-grow">
                        <h3 class="text-base md:text-xl font-bold text-[#1A305E] dark:text-white mb-2 md:mb-3 group-hover:text-[#D4AF37] transition-colors leading-tight">
                            {{ $card['title'] }}
                        </h3>
                        <p class="text-xs md:text-base text-[#4A5568] dark:text-slate-300 leading-relaxed mb-3 md:mb-6 flex-grow wrap-break-word">
                            {{ $card['desc'] }}
                        </p>
                        <div class="w-full bg-[#fafafa] dark:bg-slate-700 border border-gray-200 dark:border-slate-600 group-hover:border-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-[#1A305E] text-[#1A305E] dark:text-white px-3 md:px-5 py-2 md:py-3 rounded-xl font-bold text-xs md:text-sm transition-all shadow-sm group-hover:shadow-md flex items-center justify-center gap-2 mt-auto">
